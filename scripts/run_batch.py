"""Batch-render every .mp4 in a folder through the easyEdit pipeline (dev/QA tool).

Usage:
    python scripts/run_batch.py [INPUT_DIR] [OUTPUT_DIR]

Defaults: INPUT_DIR=./samples  OUTPUT_DIR=./output/batch
The title is derived from each file name.
"""
import os
import sys
import time
...
from easyedit.pipeline import run_pipeline  # noqa: E402
